...
var animations_dictionary = {
	ANIMATION_TYPE.WEAPON_FIRE : {"fire_attack_back": [41], "fire_attack_forward": [40], "fire_attack_left": [42], "fire_attack_right": [43], "idle_back" : [0], "idle_forward": [1], "idle_left": [2], "idle_right": [3], "near_attack_back": [18, 19], "near_attack_forward": [16, 17], "near_attack_left": [28, 29], "near_attack_right": [30, 31], "run_back" : [12, 13, 14, 15], "run_forward": [24, 25, 26, 27], "run_left": [4, 5, 6, 7], "run_right": [36, 37, 38, 39]},
}
var sprite_frame = SpriteFrames.new()
@export_file("*animation*.png") var texture_path
var texture
